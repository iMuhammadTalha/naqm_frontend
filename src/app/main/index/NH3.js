...
<div className="text-center pt-4 pb-12" style={{overflow: "auto"}}>
        <Typography className="text-48 leading-none text-purple-dark">{nh3 ? Number(nh3).toFixed(1) : 0}</Typography>
        <Typography style={{fontSize: '0.8rem'}}>ppm </Typography>
        <Typography className="text-12" color="textSecondary" style={{fontSize: '0.8rem'}} ><h1>NH3</h1></Typography>
    </div>
</Paper>
        );
    }
